...
if int(choice) != 0:
	...
	print('[10] Wolf Onyx 24h')
	print('[11] Wolf Saphire 24h')
	print('[12] Wolf Emerald 24h')
	print('[13] Wolf Ruby 24h')
	print('[14] Wolf Amber 24h')
	print('[15] Wolf Quartz 24h')
	print('[16] Wolf 5K 24h')
	print('[17] Wolf 10K 24h')
	print('[18] Wolf 15K 24h')
	print('[19] Wolf | 5K Powerlikes Dx10')
	print('[20] Wolf | 1K Powerlikes Dx10')
	print('[21] Wolf | 3K Turbo Likes Dx50')
	print('[22] 50 Likes Pod')
	print('[23] Nest DX20')
	print('[24] Dx30 Engagement Group')
	print('[25] Den DX20 (10k)')
	print('[26] Den DX50 (10k)')
	print('[27] Fast likes Dx9')
	use_groups = input('Select groups (separate with comma): ')
	print()
